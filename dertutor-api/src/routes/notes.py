...
from src.repo.model import Note, NoteLevel, Vocabulary
    ...
    async with repo.make_session() as session:
        try:
            ...
            if item:
                ...
                return Response(content='Note not found', status_code=status.HTTP_400_BAD_REQUEST)
        except DBAPIError as e:
